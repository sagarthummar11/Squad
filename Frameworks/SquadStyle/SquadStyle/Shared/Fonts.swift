...
public enum SquadFont: String {
    ...
    public var font: UIFont {
        switch self {
        case .title1: return font(.avenirNextBold, size: 28)
        ...
        case .headline2: return font(.avenirNextBold, size: 17)
        case .smallHeading: return font(.avenirNextBold, size: 15)
        case .bodyLarge: return font(.avenirNextMedium, size: 19)
        case .bodyBold: return font(.avenirNextMedium, size: 17)
        case .body: return font(.avenirNextRegular, size: 17)
        case .bodySmall: return font(.avenirNextMedium, size: 14)
        case .subhead: return font(.avenirNextBold, size: 12)
        case .footnote: return font(.avenirNextRegular, size: 10)
        }
    }
    
    private func font(_ name: SquadFontName, size: CGFloat) -> UIFont {
